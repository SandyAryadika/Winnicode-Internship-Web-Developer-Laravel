<section class="px-6 py-6">
    <h2 class="text-6xl font-semibold font-birthstone mb-6 border-b border-t pl-6 tracking-wide">
        Berita Utama <span class="text-[#FF66C4]">&gt;</span>
    </h2>

    @if ($beritaUtama->isEmpty())
        <div class="text-center py-12">
            <p class="text-lg text-gray-500">Tidak ada artikel di section <strong>Berita Utama</strong>.</p>
        </div>
    @else
