    ...
    <div class="flex gap-12 overflow-x-auto justify-center px-6 py-6">
        @foreach ($topContributors as $contributor)
            <a href="{{ route('authors.show', $contributor->id) }}"
                class="flex-shrink-0 w-48 bg-white p-4 rounded-lg border hover:shadow-lg transition duration-300 hover:shadow-blue-300 cursor-pointer block text-inherit no-underline">
